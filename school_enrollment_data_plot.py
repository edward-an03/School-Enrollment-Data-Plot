...
# Dictionary with school codes and school names
...
# List of school codes and school names dervied from school_dictionary. Created for the purpose of index finding as dictionaries don't have ordered indices
...
def calculate_mean_enrollment(school_code, grade):
    ...
    """
    row_index = school_codes_list.index(school_code) #s chool is determined by this index
